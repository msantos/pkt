...
decode() ->
    ?_assertEqual({{lldp, [{chassis_id,mac_address,<<0,1,48,249,173,160>>},
                           ...
                           {organizationally_specific,<<0,18,15,1,3,108,0,0,16>>, undefined, undefined},
                           {organizationally_specific,<<0,18,15,3,1,0,0,0,0>>, undefined, undefined},
                           {organizationally_specific,<<0,18,15,4,5,242>>, undefined, undefined},
                           {organizationally_specific,<<0,128,194,1,1,232>>, undefined, undefined},
                           {organizationally_specific,<<0,128,194,2,1,0,0>>, undefined, undefined},
                           {organizationally_specific,<<0,128,194,3,1,232,16,118,
                                                        50,45,48,52,56,56,45,48,51,45,48, 53,48,53,0>>, undefined, undefined},
                           {organizationally_specific,<<0,128,194,4,0>>, undefined, undefined},
                           end_of_lldpdu]}, <<>>},
                  pkt:lldp(packet())).
